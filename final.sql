-- NOVA Pharmacy Project - Final SQL Script
-- Includes corrected schema, triggers, procedures, indexes, and dummy data
-- ==========================
-- 1. Table Definitions
-- ==========================
...
-- Keep only latest prescription per doctor-patient
CREATE TRIGGER Keep_Latest_Prescription
BEFORE INSERT ON Prescription
FOR EACH ROW
BEGIN
    DELETE FROM Prescription
    WHERE DoctorID = NEW.DoctorID AND PatientID = NEW.PatientID;
END;
...
INSERT INTO Doctor VALUES 
    ('D0001', 'Dr. A', 'Cardiology', 10),
    ('D0002', 'Dr. B', 'Neurology', 8);

INSERT INTO Patient VALUES 
    ('P0001', 'Alice', '123 Main St', '1990-05-10', 'D0001'),
    ('P0002', 'Bob', '456 Park Ave', '1985-07-15', 'D0002');

-- Pharma Companies
INSERT INTO PharmaceuticalCompany VALUES ('PharmaX', '9999999999');
INSERT INTO PharmaceuticalCompany VALUES ('PharmaY', '8888888888');

-- Drugs
INSERT INTO Drug VALUES ('Paracetamol', 'C8H9NO2', 'PharmaX');
INSERT INTO Drug VALUES ('Ibuprofen', 'C13H18O2', 'PharmaX');
INSERT INTO Drug VALUES ('Amoxicillin', 'C16H19N3O5S', 'PharmaY');
INSERT INTO Drug VALUES ('Drug1', 'F1', 'PharmaX');
INSERT INTO Drug VALUES ('Drug2', 'F2', 'PharmaX');
INSERT INTO Drug VALUES ('Drug3', 'F3', 'PharmaX');
INSERT INTO Drug VALUES ('Drug4', 'F4', 'PharmaX');
INSERT INTO Drug VALUES ('Drug5', 'F5', 'PharmaX');
INSERT INTO Drug VALUES ('Drug6', 'F6', 'PharmaX');
INSERT INTO Drug VALUES ('Drug7', 'F7', 'PharmaX');

-- Pharmacy
INSERT INTO Pharmacy VALUES ('NovaCentral', 'Downtown', '7777777777');

-- Sells
INSERT INTO Sells VALUES ('NovaCentral', 'Paracetamol', 'PharmaX', 5.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Ibuprofen', 'PharmaX', 8.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Amoxicillin', 'PharmaY', 12.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug1', 'PharmaX', 6.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug2', 'PharmaX', 7.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug3', 'PharmaX', 9.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug4', 'PharmaX', 11.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug5', 'PharmaX', 13.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug6', 'PharmaX', 15.00);
INSERT INTO Sells VALUES ('NovaCentral', 'Drug7', 'PharmaX', 17.00);

-- Prescriptions
INSERT INTO Prescription VALUES ('D0001', 'P0001', DATE '2025-04-15');
INSERT INTO PrescriptionDrug VALUES ('D0001', 'P0001', DATE '2025-04-15', 'Paracetamol', 'PharmaX', 2);
INSERT INTO PrescriptionDrug VALUES ('D0001', 'P0001', DATE '2025-04-15', 'Ibuprofen', 'PharmaX', 1);

-- Contract
INSERT INTO Contract VALUES ('PharmaX', 'NovaCentral', DATE '2025-01-01', DATE '2026-01-01', 'Standard supply contract.', 'D0001');

INSERT INTO Doctor (AadharID, Name, Specialty)
VALUES ('D1', 'Dr. Smith', 'Cardiology');
...
get_pharmacy_stock('NovaCentral');

-- Test the new utility procedures
CALL get_pharmacy_stock('NovaCentral');
CALL get_pharmacy_pharma_contacts('NovaCentral');